...
public class FunctionComplexityCheckCombiTest {
  ...
  public void test() {
    ...
    CheckMessagesVerifier.verify(file.getCheckMessages())
        .next().atLine(53).withMessage("Function has a complexity of 3 which is greater than 1 authorized.")
       .next().atLine(62).withMessage("Function has a complexity of 29 which is greater than 1 authorized.")
