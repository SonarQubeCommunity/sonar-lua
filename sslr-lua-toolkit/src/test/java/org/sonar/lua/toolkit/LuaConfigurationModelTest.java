...
public class LuaConfigurationModelTest {
  ...
  public void getConfiguration_charset() {
    LuaConfigurationModel model = new LuaConfigurationModel();
  ...
  public void getPropertyOrDefaultValue_with_property_set() {
    ...
    try {
      ...
      assertThat(LuaConfigurationModel.getPropertyOrDefaultValue("foo", "baz")).isEqualTo("bar");
    } finally {
      if (oldValue == null) {
  ...
  public void getPropertyOrDefaultValue_with_property_not_set() {
    ...
    try {
      System.clearProperty("foo");
      assertThat(LuaConfigurationModel.getPropertyOrDefaultValue("foo", "baz")).isEqualTo("baz");
    } finally {
      if (oldValue == null) {
        System.clearProperty("foo");
      } else {
