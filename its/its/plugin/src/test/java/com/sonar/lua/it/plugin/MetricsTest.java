...
public class MetricsTest {
  ...
  public static void startServer() {
    ...
    orchestrator.getServer().associateProjectToQualityProfile(PROJECT_KEY, "lua", "no_rule");
  ...
  private Measure getFileMeasure(String metricKey) {
    Resource resource = wsClient.find(ResourceQuery.createForMetrics(keyFor("dir/helloWorld.lua"), metricKey));
    return resource == null ? null : resource.getMeasure(metricKey);
  }
