...
package com.sonar.lua.it.plugin;
...
import static com.sonar.lua.it.plugin.Tests.assertProjectMeasures;
...
public class TestReportTest {
  ...
  private SonarRunner createBuild(String testReportPath) {
    return SonarRunner.create()
      ...
      .setProperty("sonar.lua.xunit.reportPath", testReportPath);
  }

  @Test
  public void import_report() throws Exception {
    // sonar.lua.xunit.skipDetails=false by default
  ...
  public void simple_mode() throws Exception {
    orchestrator.executeBuild(createBuild("nosetests.xml").setProperty("sonar.lua.xunit.skipDetails", "true"));
  ...
  public void missing_test_report_with_simple_mode() throws Exception {
    orchestrator.executeBuild(createBuild("missing.xml").setProperty("sonar.lua.xunit.skipDetails", "true"));
    assertProjectMeasures(PROJECT, nullMeasures());
  }
