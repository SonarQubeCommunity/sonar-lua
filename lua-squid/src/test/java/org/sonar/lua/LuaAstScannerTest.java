...
public class LuaAstScannerTest {
	 ...
	 @Test
	  public void lines() {
	    ...
	    assertThat(file.getInt(LuaMetric.LINES)).isEqualTo(18);
	  }
	 ...
	 @Test
	  public void TableConstructors() {
	    ...
	    assertThat(file.getInt(LuaMetric.TABLECONSTRUCTORS)).isEqualTo(10);
	  } 
	 @Test
	 ...
	 @Test
	  public void complexity() {
	    ...
	    assertThat(file.getInt(LuaMetric.COMPLEXITY)).isEqualTo(15);
	  }
}